...
public class Run {
	public static void main(String[] args) {
		...
		// p1 변수로는 Parent 타입의 객체만 사용가능
		
		Child1 c1 = new Child1();
		c1.printChild1();
		c1.printParent();
		// c1 변수로는 Child1, Parent타입 객체 사용 가능
		
		// = 을 기준으로 양변의 자료형이 같아야한다.
		// Parent p2 = new Child1(); // (Parent)
		...
		// Parent p3 = (Parent)new Test(); 상속을 받지 않았기 때문에 사용할 수 없다.
		p2.printParent();
		// p2.printChild1();
		// p2로는 Parent타입 객체만 사용가능
		((Child1)p2).printChild1();
		
		// 부모타입 자료형으로 자식객체를 다룰 수 있음
		/*
		 * 클래스 형 변환
		 * 
		 * "상속 구조"일 경우에만 가능
