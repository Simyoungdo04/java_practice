...
public class InputKeyBoard {
	/*
	 * 키보드를 이용해서 프로그램 사용자에게 값을 입력받아 보기
	 * 자바에서 제공해주는 Scanner라는 클래스를 사용 해서 입력받기
	 * Scanner라는 클래스에 존재하는 메소드들을 호출해서 입력을 받을 수 있다
	 */
	public void inputTest() {
		...
		System.out.println(select + "을(를) " + pizzaNumber + "판 주문하셨습니다.");
